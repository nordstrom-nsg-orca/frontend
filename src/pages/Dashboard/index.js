      ...
      <div>
        <Paper style={{ padding: '16px' }}>
          ...
          <Typography style={{ marginTop: '8px' }}>
            The design of Schemas is based off of <a target='_blank' href='https://json-schema.org/' without rel='noopener noreferrer' style={{ textDecoration: 'underline' }}>JSON Schema</a>. The schema's created here are processed into JSON Schema definitions which are used for data validation. An understanding of JSON Schema isn't required to use Orca, though.
          </Typography>
        </Paper>
